...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/usr/local/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include".split(';') if "/usr/local/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include" != "" else []
